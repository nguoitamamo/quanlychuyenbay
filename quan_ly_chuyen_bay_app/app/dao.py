from quan_ly_chuyen_bay_app.app.models import SanBay, TuyenBay, SanBayTrungGian, NhanVien, ChuyenBay, MayBay, Ghe, Ve, KhachHang, db, \
...
from quan_ly_chuyen_bay_app.app import app
